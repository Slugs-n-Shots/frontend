                    ...
                    <Card className="shadow-lg border-0 rounded-lg mt-5">
                        <Card.Header>
                            <h3 className="text-center font-weight-light my-4">
                                {__('Resend Registration confirmation email')}
                            </h3>
                        </Card.Header>
                        <Card.Body>
                            <div className="small mb-3 text-muted">
                                {__('Enter your email address and we will send you a link to email confirmation page.')}
                            </div>
                            <Form onSubmit={handleSubmit}>
                                ...
                                <div className="d-flex align-items-center justify-content-between mt-4 mb-0">
                                    ...
                                    <Button variant="primary" type="submit" {...(formIsValid ? {} : { disabled: true })} className="btn-block" >{__('Resend Confirmation')}</Button>
                                </div>
                            </Form>
                        </Card.Body>
